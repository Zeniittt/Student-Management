...
namespace _20110016_NguyenQuocDucTin_QLSV {
    ...
    public partial class QLSVDataSet3 : global::System.Data.DataSet {
        ...
        public partial class StudentRow : global::System.Data.DataRow {
            ...
            public int stt {
                get {
                    return ((int)(this[this.tableStudent.sttColumn]));
                }
                set {
                    this[this.tableStudent.sttColumn] = value;
                }
            }
...
namespace _20110016_NguyenQuocDucTin_QLSV.QLSVDataSet3TableAdapters {
...
SELECT stt, id, fname, lname, email, major, faculty, bdate, gender, phone, hometown, address, picture FROM Student WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [id] = @id, [fname] = @fname, [lname] = @lname, [email] = @email, [major] = @major, [faculty] = @faculty, [bdate] = @bdate, [gender] = @gender, [phone] = @phone, [hometown] = @hometown, [address] = @address, [picture] = @picture WHERE (([stt] = @Original_stt) AND ([id] = @Original_id) AND ((@IsNull_fname = 1 AND [fname] IS NULL) OR ([fname] = @Original_fname)) AND ((@IsNull_lname = 1 AND [lname] IS NULL) OR ([lname] = @Original_lname)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_major = 1 AND [major] IS NULL) OR ([major] = @Original_major)) AND ((@IsNull_faculty = 1 AND [faculty] IS NULL) OR ([faculty] = @Original_faculty)) AND ((@IsNull_bdate = 1 AND [bdate] IS NULL) OR ([bdate] = @Original_bdate)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_hometown = 1 AND [hometown] IS NULL) OR ([hometown] = @Original_hometown)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)));
SELECT stt, id, fname, lname, email, major, faculty, bdate, gender, phone, hometown, address, picture FROM Student WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT stt, id, fname, lname, email, major, faculty, bdate, gender, phone, hometo" +
                "wn, address, picture FROM dbo.Student";
        ...
        public virtual int Delete(int Original_stt, string Original_id, string Original_fname, string Original_lname, string Original_email, string Original_major, string Original_faculty, global::System.Nullable<global::System.DateTime> Original_bdate, string Original_gender, string Original_phone, string Original_hometown, string Original_address) {
            ...
            if ((Original_bdate.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[13].Value = ((System.DateTime)(Original_bdate.Value));
            }
            else {
        ...
        public virtual int Update(
            ...
            if ((Original_hometown == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[31].Value = ((string)(Original_hometown));
            }
            if ((Original_address == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_hometown, 
                    string Original_address) {
            return this.Update(Original_id, fname, lname, email, major, faculty, bdate, gender, phone, hometown, address, picture, Original_stt, Original_id, Original_fname, Original_lname, Original_email, Original_major, Original_faculty, Original_bdate, Original_gender, Original_phone, Original_hometown, Original_address);
        }
    }
