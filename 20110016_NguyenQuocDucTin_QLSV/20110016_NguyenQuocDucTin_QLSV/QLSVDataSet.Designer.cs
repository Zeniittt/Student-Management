...
namespace _20110016_NguyenQuocDucTin_QLSV {
    ...
    public partial class QLSVDataSet : global::System.Data.DataSet {
        ...
        public partial class CourseDataTable : global::System.Data.TypedTableBase<CourseRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CourseRow AddCourseRow(int id, string semester, string lable, int period, string description) {
...
namespace _20110016_NguyenQuocDucTin_QLSV.QLSVDataSetTableAdapters {
    ...
    public partial class CourseTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Course] ([id], [semester], [lable], [period], [description]) V" +
                "ALUES (@id, @semester, @lable, @period, @description);\r\nSELECT id, semester, lab" +
                "le, period, description FROM Course WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Course] SET [id] = @id, [semester] = @semester, [lable] = @lable, [period] = @period, [description] = @description WHERE (([id] = @Original_id) AND ((@IsNull_semester = 1 AND [semester] IS NULL) OR ([semester] = @Original_semester)) AND ((@IsNull_lable = 1 AND [lable] IS NULL) OR ([lable] = @Original_lable)) AND ((@IsNull_period = 1 AND [period] IS NULL) OR ([period] = @Original_period)) AND ((@IsNull_description = 1 AND [description] IS NULL) OR ([description] = @Original_description)));
SELECT id, semester, lable, period, description FROM Course WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, semester, lable, period, description FROM dbo.Course";
        ...
        public virtual int Delete(int Original_id, string Original_semester, string Original_lable, global::System.Nullable<int> Original_period, string Original_description) {
            ...
            if ((Original_period.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((int)(Original_period.Value));
            }
            else {
        ...
        public virtual int Insert(int id, string semester, string lable, global::System.Nullable<int> period, string description) {
        ...
        public virtual int Update(int id, string semester, string lable, global::System.Nullable<int> period, string description, int Original_id, string Original_semester, string Original_lable, global::System.Nullable<int> Original_period, string Original_description) {
            ...
            if ((Original_lable == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_lable));
            }
            if ((Original_period.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[10].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[11].Value = ((int)(Original_period.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string semester, string lable, global::System.Nullable<int> period, string description, int Original_id, string Original_semester, string Original_lable, global::System.Nullable<int> Original_period, string Original_description) {
            return this.Update(Original_id, semester, lable, period, description, Original_id, Original_semester, Original_lable, Original_period, Original_description);
        }
    }
