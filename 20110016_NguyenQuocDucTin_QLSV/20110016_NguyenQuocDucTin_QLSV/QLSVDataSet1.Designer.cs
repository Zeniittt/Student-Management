...
namespace _20110016_NguyenQuocDucTin_QLSV {
    ...
    public partial class QLSVDataSet1 : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentRow AddStudentRow(string id, string fname, string lname, string email, string major, string faculty, System.DateTime bdate, string gender, string phone, string hometown, string address, byte[] picture) {
...
namespace _20110016_NguyenQuocDucTin_QLSV.QLSVDataSet1TableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Student] ([id], [fname], [lname], [email], [major], [faculty], [bdate], [gender], [phone], [hometown], [address], [picture]) VALUES (@id, @fname, @lname, @email, @major, @faculty, @bdate, @gender, @phone, @hometown, @address, @picture);
SELECT id, fname, lname, email, major, faculty, bdate, gender, phone, hometown, address, picture FROM Student WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [id] = @id, [fname] = @fname, [lname] = @lname, [email] = @email, [major] = @major, [faculty] = @faculty, [bdate] = @bdate, [gender] = @gender, [phone] = @phone, [hometown] = @hometown, [address] = @address, [picture] = @picture WHERE (([id] = @Original_id) AND ((@IsNull_fname = 1 AND [fname] IS NULL) OR ([fname] = @Original_fname)) AND ((@IsNull_lname = 1 AND [lname] IS NULL) OR ([lname] = @Original_lname)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_major = 1 AND [major] IS NULL) OR ([major] = @Original_major)) AND ((@IsNull_faculty = 1 AND [faculty] IS NULL) OR ([faculty] = @Original_faculty)) AND ((@IsNull_bdate = 1 AND [bdate] IS NULL) OR ([bdate] = @Original_bdate)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_hometown = 1 AND [hometown] IS NULL) OR ([hometown] = @Original_hometown)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)));
SELECT id, fname, lname, email, major, faculty, bdate, gender, phone, hometown, address, picture FROM Student WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, fname, lname, email, major, faculty, bdate, gender, phone, hometown, a" +
                "ddress, picture FROM dbo.Student";
        ...
        public virtual int Fill(QLSVDataSet1.StudentDataTable dataTable) {
        ...
        public virtual QLSVDataSet1.StudentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QLSVDataSet1.StudentDataTable dataTable = new QLSVDataSet1.StudentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QLSVDataSet1.StudentDataTable dataTable) {
        ...
        public virtual int Delete(string Original_id, string Original_fname, string Original_lname, string Original_email, string Original_major, string Original_faculty, global::System.Nullable<global::System.DateTime> Original_bdate, string Original_gender, string Original_phone, string Original_hometown, string Original_address) {
            if ((Original_id == null)) {
            ...
            if ((Original_bdate.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[12].Value = ((System.DateTime)(Original_bdate.Value));
            }
            else {
            ...
            if ((Original_hometown == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[18].Value = ((string)(Original_hometown));
            }
        ...
        public virtual int Insert(string id, string fname, string lname, string email, string major, string faculty, global::System.Nullable<global::System.DateTime> bdate, string gender, string phone, string hometown, string address, byte[] picture) {
            if ((id == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_faculty == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[22].Value = ((string)(Original_faculty));
            }
            if ((Original_bdate.HasValue == true)) {
        ...
        public virtual int Update(
                    ...
                    string Original_hometown, 
                    string Original_address) {
            return this.Update(Original_id, fname, lname, email, major, faculty, bdate, gender, phone, hometown, address, picture, Original_id, Original_fname, Original_lname, Original_email, Original_major, Original_faculty, Original_bdate, Original_gender, Original_phone, Original_hometown, Original_address);
        }
    }
